    ...
    return function (e) {
        ...
        function c(e, t) {
            for (var n = {}, r = [], i = 0; i < e.length; i++) {
                ...
                n[c] = s + 1;
                var u = l(d), h = {css: o[1], media: o[2], sourceMap: o[3]};
        ...
        var r = n(1), i = n.n(r), o = n(0), a = n.n(o), l = n(2), c = n.n(l), s = n(3), d = n.n(s), u = {
            ...
            youtube: {
                ...
                id: function (e) {
                    ...
                    if (!r && n) return n;
                    var i = {start: "start", end: "end", t: "start", time_continue: "start", list: "list"};
            ...
            //     embedUrl: "https://player.twitch.tv/?channel=<%= remote_id %>&parent="+window.location.host,
            ...
            //     embedUrl: "https://player.twitch.tv/?video=v<%= remote_id %>&parent="+window.location.host,
            //     html: '<iframe frameborder="0" allowfullscreen="true" scrolling="no" height="366" style="width:100%;"></iframe>',
            //     height: 366,
            //     width: 600
            // },
            ...
            //     //https://music.yandex.ru/iframe/#track/110955824/24725186
            ...
            return d()(e, [{
                key: "render", value: function () {
                    ...
                    var r = e.services[this.data.service].html, i = document.createElement("div"),
                        o = document.createElement("div"), a = document.createElement("template"),
                ...
                key: "onPaste", value: function (t) {
                    var n = t.detail, r = n.key, i = n.data, o = e.services[r], a = o.regex, l = o.embedUrl,
                        c = o.width, s = o.height, d = o.id, u = void 0 === d ? function (e) {
                            return e.shift()
                        } : d, h = a.exec(i).slice(1), m = l.replace(/<%= remote_id %>/g, u(h));
                    this.data = {service: r, source: i, embed: m, width: c, height: s}
                }
            }, {
                key: "embedIsReady", value: function (e) {
                    var t = null;
                    return new Promise((function (n, r) {
                        (t = new MutationObserver(Object(h.debounce)(n, 450))).observe(e, {childList: !0, subtree: !0})
                    })).then((function () {
                        t.disconnect()
                    }))
                }
                ...
                key: "data", set: function (e) {
                    ...
                    var t = e.service, n = e.source, r = e.embed, i = e.width, o = e.height, a = e.caption,
                        l = void 0 === a ? "" : a;
                    this._data = {
                ...
                key: "prepare", value: function (t) {
                    var n = t.config, r = (void 0 === n ? {} : n).services, o = void 0 === r ? {} : r,
                        l = Object.entries(u), c = Object.entries(o).filter((function (e) {
                ...
                key: "checkServiceConfig", value: function (e) {
                    var t = e.regex, n = e.embedUrl, r = e.html, i = e.height, o = e.width, a = e.id,
